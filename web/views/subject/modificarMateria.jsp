<%-- 
    ...
    Created on : 10/03/2020, 10:09:52 PM
    Author     : Zaira
--%>
...
<html lang="es" ng-app="inicioMaterias">
    <head >
        ...
        <title>Modificar Materia | SGAA</title>
                                            ...
                                            <div class="">
                                                <div class="card page-header p-0">
                                                        ...
                                                        <div class="col">
                                                            <div class="page-header-breadcrumb">
                                                                <ul class="breadcrumb-title">
                                                                    <a style="font-size: 50px" href="inicioMateria"><i class="icofont icofont-circled-left"></i></a>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-block">
                                                        <form id="main" method="post" action="<%=context%>/modificarMateria" >
                                                            <s:hidden name="bean.id_materia" value="%{bean.id_materia}"/>
                                                            
                                                            <!--<input type="text" name="bean.id_materia" value="<s:property value="%{bean.id_materia}"/>"/>-->
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Identificador <span style="color: red">*</span></label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" value="<s:property value="%{bean.identificador}"/>"  name="bean.identificador" id="bean.siglas" placeholder="TIC">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" value="<s:property value="%{bean.nombre}"/>"  id="bean.nombre" name="bean.nombre" placeholder="Tecnologías de la información y comunicación">
                                                                    <span class="messages"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" value="<s:property value="%{bean.desc}"/>" id="bean.descripcion" name="bean.desc" placeholder="Materia encargada con las nuevas tecnologias">
                                                                    <span class="messages"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <select type="text" class="form-control" value="<s:property value="%{bean.numero_cuatri.id_numero_cuatri}"/>" id="bean.numero_cuatri.id_numero_cuatri" name="bean.numero_cuatri.id_numero_cuatri" placeholder="1">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <select type="text" class="form-control" value="<s:property value="%{bean.carrera.id_carrera}"/>" id="bean.carrera" name="bean.carrera.id_carrera" placeholder="Materia encargada con las nuevas tecnologias">
