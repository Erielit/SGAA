                    ...
                    <div class="pcoded-wrapper">
                        ...
                        <div class="pcoded-content">
                            <div class="pcoded-inner-content">
                                <div class="main-body">
                                    <s:iterator value="" status="po">                                  
                                        <div class="card" style="width: 18rem;">
                                            <div class="card-header">
                                                <s:property value=""/> Featured
                                            </div>
                                            <div class="card-body">
                                                <p class="card-text"><s:property value=""/>With supporting text below as a natural lead-in to additional content.</p>
                                            </div>
