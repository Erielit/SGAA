                                            ...
                                            <div class="row">
                                                <div class="col-md-6 offset-3">
                                                    <form class="needs-validation">
                                                        <input type="hidden" id="idCuatrimestre" value="<s:property value="respuesta.cuatrimestre.id_cuatrimestre"/>"/>
                                                        <div class="form-group">
                                                            <label for="nombreQuarter">Nombre</label>
                                                            <input type="text" value="<s:property value="respuesta.cuatrimestre.nombre"/>" class="form-control" required="" id="nombre" aria-describedby="Nombre Cuatrimestre" placeholder="Escribe un nombre...">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="fechaInicio">Fecha de Inicio</label>
                                                            <input type="date" value="<s:property value="respuesta.cuatrimestre.fecha_inicio"/>" class="form-control" required="" id="fechaInicio" placeholder="Selecciona una Fecha">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="fechaFin">Fecha de Fin</label>
                                                            <input type="date" value="<s:property value="respuesta.cuatrimestre.fecha_fin"/>" class="form-control" required="" id="fechaFin" placeholder="Selecciona una Fecha">
                                                        </div>
                                                        <div class="text-right">
                                                            <button type="button" id="modificar" class="btn btn-primary" onclick="pModificar()">Modificar</button>
                                                            <button type="button" id="cancelar" class="btn btn-secondary" onclick="back()">Cancelar</button>
                                                        </div>
                                                    </form>
                                                </div>                                                
                                            </div>
