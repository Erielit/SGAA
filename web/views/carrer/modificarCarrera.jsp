<%-- 
    ...
    Created on : 10/03/2020, 09:00:40 AM
    Author     : Zaira
--%>
...
<html lang="es" ng-app="inicioCarreras">
    <head >
        ...
        <title>Modificar Carrera | SGAA</title>
    ...
    <body ng-controller="controladorCarrera">
        <!-- Pre-loader start -->
                                        ...
                                        <div class="page-body">
                                            <div class="">
                                                ...
                                                <div class="card-block">
                                                    <form id="main" method="post" action="<%=context%>/modificarCarreraJson">
                                                        <s:hidden name="bean.id_carrera" value="%{bean.id_carrera}"/>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Siglas <span style="color: red">*</span></label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" value="<s:property value="%{bean.siglas}"/>"  name="bean.siglas" id="bean.siglas" placeholder="TIC">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" value="<s:property value="%{bean.descripciont}"/>" id="bean.descripcion" name="bean.descripciont" placeholder="Carrera encargada con las nuevas tecnologias">
                                                                <span class="messages"></span>
                                                            </div>
                                                        </div>
